...
g<-faceted_FM_plot(dist_to_compare = c("hellinger", "harmonic_mean", "euclidean", "sorensen", "avg", "jensen-shannon", "bhattacharyya", "squared_chi", "cosine"))
fig<-ggplotly(g)
fig
...
dend_dmetrics<-hclust(as.dist(1-mat), method="average")
...
#######
#Next time: change similarity metrics to distance metrics!!! hclust operates on dissimilarity so need to correct
#######
```
